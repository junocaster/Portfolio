...
.wrapper .main_content .table table td{
  width: 50%;
}
    ...
    <div class="main_content" id="main_content" >
        ...
        <div class="table">
          <table>
            ...
            <tr>
              <td> <a href="card.php"><img src="ICONS/BANK.png"> </a> </td>
              <td> <a href="piggy.php"><img src="ICONS/PIGGY BANK 2.png"> </a> </td>
            </tr>
            <tr>
              <td><p>Card Management</p> </td>
              <td><p>BND Piggy Bank</p></td>
            </tr>
