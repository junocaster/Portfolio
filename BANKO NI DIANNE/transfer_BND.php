...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $receipt =  "\n"."Transfer to BND Bank". " | " . "Php ". number_format($withdrawAmount, 2) . " | " . date("Y-m-d H:i:s") . " | " .$refNumber ;
...
<div class="wrapper">
    ...
    <div class="main_content" id="main_content" >
      <div class="header"> 
          <h2>TRANSFER TO ANOTHER BND BANK ACCOUNT</h2> 
          <p>You are the Best with BND!</p>
          <br> 
      </div> 
      ...
      if(AccNum && Amount){
        ...
        if(typeof refNumber == 'undefined'){
            ...
            content.innerHTML =
              ...
              // Update modal content with transaction details
            content.innerHTML =
              "<h3>TRANSFER TO BND SUCCESSFUL!</h3><br>" +
